...
/**
 * Kernel Log Handler of BugReport.
 * @Author Tam.
 * Modifications :
 * 2017/4/17 : Created.
 */
public class KernelLogHandler extends ModuleHandler {

    private final static String TAG = "KernelLog";

    public KernelLogHandler(FileWrapper fileWrapper, String filter, int parseMode) {
        super(TAG, StatisticInfo.ChapterMapping.CHAPTER_KERNEL_LOGS, fileWrapper, filter, parseMode);
    }
