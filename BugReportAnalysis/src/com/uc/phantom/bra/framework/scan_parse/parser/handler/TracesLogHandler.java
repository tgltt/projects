 ...
 * 2017/4/17 : Created.
 */
public class TracesLogHandler extends ModuleHandler {

    private final static String TAG = "TracesLog";

    public TracesLogHandler(FileWrapper fileWrapper, String filter, int parseMode) {
        super(TAG, StatisticInfo.ChapterMapping.CHAPTER_TRACES, fileWrapper, filter, parseMode);
    }
