...
/**
 * App Services Chapter Handler of BugReport.
 * @Author Tam.
 * Modifications :
 * 2017/4/17 : Created.
 */
public class AppServicesHandler extends ModuleHandler {

    private final static String TAG = "APP SERVICES";

    public AppServicesHandler(FileWrapper fileWrapper, String filter, int parseMode) {
        super(TAG, StatisticInfo.ChapterMapping.CHAPTER_APP_SERVICES, fileWrapper, filter, parseMode);
    }
    ...
    public void onModuleStart(String curLine, FileWrapper fileWrapper, BugReportParseEngine.ParseResult parseResult) throws IOException {
        ...
        do {
            ...
            if (line.startsWith(Consts.BUGREPORT_CHAPTER_APP_SERVICES_FILTER)) {
        ...
        } while (line != null && StringUtils.kmp_indexOf(line, Consts.BUGREPORT_CHAPTER_APP_SERVICES_END) < 0);
