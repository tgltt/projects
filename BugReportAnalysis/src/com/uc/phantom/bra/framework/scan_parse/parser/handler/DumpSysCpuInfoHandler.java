...
/**
 * DumpSys CpuInfo Chapter Handler of BugReport.
 * @Author Tam.
 * Modifications :
 * 2017/4/17 : Created.
 */
public class DumpSysCpuInfoHandler extends ModuleHandler {

    private final static String TAG = "DUMPSYS CPUINFO";

    public DumpSysCpuInfoHandler(FileWrapper fileWrapper, String filter, int parseMode) {
        super(TAG, StatisticInfo.ChapterMapping.CHAPTER_DUMPSYS_CPUINFO, fileWrapper, filter, parseMode);
    }
    ...
    public void onModuleStart(String curLine, FileWrapper fileWrapper, BugReportParseEngine.ParseResult parseResult) throws IOException {
        ...
        } while (line != null && StringUtils.kmp_indexOf(line, Consts.BUGREPORT_CHAPTER_DUMPSYS_CPUINFO_END) < 0);
