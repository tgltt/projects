...
/**
 * Checkin Package Chapter Handler of BugReport.
 * @Author Tam.
 * Modifications :
 * 2017/4/17 : Created.
 */
public class CheckinPackageHandler extends ModuleHandler {

    private final static String TAG = "CHECKIN PACKAGE";

    public CheckinPackageHandler(FileWrapper fileWrapper, String filter, int parseMode) {
        super(TAG, StatisticInfo.ChapterMapping.CHAPTER_CHECKIN_PACKAGE, fileWrapper, filter, parseMode);
    }
    ...
    public void onModuleStart(String curLine, FileWrapper fileWrapper, BugReportParseEngine.ParseResult parseResult) throws IOException {
        ...
        } while (line != null && StringUtils.kmp_indexOf(line, Consts.BUGREPORT_CHAPTER_CHECKIN_PACKAGE_END) < 0);
